...
//     if (config.isValid) {
//       const appiumOptions = config.config?.server || {};
//       if (this._portOccupied(appiumOptions.port)) {
//         const portFromUser = await this._getPortFromUser();
//         if (!!portFromUser) {
//           await this._startAppiumService(appiumOptions.address, portFromUser, config);
//         }
//       } else {
//         await this._startAppiumService(appiumOptions.address, appiumOptions.port, config);
//       }
//     } else {
...
//   private async _startAppiumService(address: string, port: number, config: ConfigFile) {
